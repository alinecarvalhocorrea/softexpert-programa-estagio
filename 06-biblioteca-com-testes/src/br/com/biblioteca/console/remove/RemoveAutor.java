...
public class RemoveAutor {
	...
	public void removerAutor() {
		...
		boolean verifica = new PesquisaAutorPorCodigoSequencial(scanner, bancoDeAutores)
				.verificaExistenciaDeAutorPorCodigoSequencial(codigoSequencial);
		if (verifica) {
			...
			System.out.println(
					"Autor(a) não encontrado(a). Por favor, verifique o código sequencial informado e tente novamente.");
			return;
		}
	}
