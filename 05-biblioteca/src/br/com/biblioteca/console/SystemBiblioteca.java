					...
					if(opcaoPesquisar.equals("3")){
						...
						System.out.println("\n");
							...
							if(opcaoPesquisarLivro.equals("1")){
								...
								System.out.println("-----------------------------------------------------------------");
								System.out.println("\n");
								PesquisaLivroPorCodigoSequencial pesquisaLivro = new PesquisaLivroPorCodigoSequencial(scanner, bancoDeLivros);
							...
							if(opcaoPesquisarLivro.equals("2")){
								...
								System.out.println("-----------------------------------------------------------------");
								System.out.println("\n");
								PesquisaLivroPorCodigoDeBarras pesquisaLivro = new PesquisaLivroPorCodigoDeBarras(scanner, bancoDeLivros);
