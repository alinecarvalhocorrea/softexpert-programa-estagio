...
public class Biblioteca {
	private static void verificarPesquisaDeLivros(Collection<Livro> livrosEncontrados){
	...
	public static void main(String[] args) {
		...
		Livro livro1 = new Livro(autor1,categoria1,"Bola Abelha Arvore","a8");
		livro1.setDataDeAquisicao("25/02/2016");
		Livro livro2 = new Livro(autor2,categoria2,"Aline Testando o sistema","d2");
		livro2.setDataDeAquisicao("10/04/2017");
		...
		while (opcaoIndex != 6) {
			...
			if (opcaoIndex == 1) {
				...
				System.out.println("        5 - Consultar Categoria por Descrição");
				System.out.println("        6 - Consultar Categoria por Código Sequencial");
				System.out.println("    Consultar Autor");
				System.out.println("        7 - Consultar Autor por Nome");
				System.out.println("        8 - Consultar Autor por Nacionalidade");
				System.out.println("        9 - Consultar Autor por Data de Nascimento");
				System.out.println("        10 - Consultar Autor por Código Sequencial");
				System.out.println("Insira a opção desejada: ");
				...
				if (opcao1 == 0) {
					...
					String pesquisaPorTitulo = " " + entrada.nextLine();
					System.out.println("Consultando no Banco de Livros...");
					Set<Livro> livrosEncontrados = bancoDeLivros.buscarPorTitulo(pesquisaPorTitulo);
					verificarPesquisaDeLivros(livrosEncontrados);
				}
				if (opcao1 == 1) {
					System.out.println("Consultar Livro por Código Sequencial");
					System.out.println("Insira o código sequencial: ");
					String pesquisaPorCodigoSequencial = entrada.nextLine();
				...
				if (opcao1 == 3) {
					...
					List<Livro> livrosEncontrados = bancoDeLivros.buscarPorCategoria(pesquisaPorCategoria);
					verificarPesquisaDeLivros(livrosEncontrados);
				}
				if (opcao1 == 4) {
					// TODO SISTEMA : Consultar livros por autor
					System.out.println("Consultar Livros por autor");
					System.out.println("Insira o nome do autor: ");
					String pesquisaPorAutor = entrada.next();
					System.out.println("\nConsultando no Banco de Livros...");
					/* TODO ERRO : Pesquisa de livros por autor
					 * Exception in thread "main" java.lang.NullPointerException
						at biblioteca.Livro.getAutor(Livro.java:175)
						at biblioteca.memoria.BancoDeLivros.buscarPorAutor(BancoDeLivros.java:116)
						at biblioteca.console.Biblioteca.main(Biblioteca.java:129)*/
					List<Livro> livrosEncontrados = bancoDeLivros.buscarPorAutor(pesquisaPorAutor);
					verificarPesquisaDeLivros(livrosEncontrados);
